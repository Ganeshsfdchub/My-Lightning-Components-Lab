...
export default class LightningRecordFormUpdateRecordImport extends LightningElement 
{
    ...
    @api objectApiName;
     ...
     //@track fields = [Account.Name, Account.Industry, Account.Rating, Account.Phone]
     // @track allfields
